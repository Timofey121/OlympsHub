...
from TelegramBot.keyboards.inline.all_or_choice_notification import inline_buttons_choose_notification
from TelegramBot.keyboards.inline.buttons_lessons_notification import inline_buttons_lessons_notification
from TelegramBot.loader import dp
from TelegramBot.utils.db_api.PostgreSQL import subscriber_exists, data_olympiads, add_notification_dates, select_data_infor_id, \
