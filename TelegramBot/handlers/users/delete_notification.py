...
from TelegramBot.keyboards.inline.buttons_lessons_del_notif import inline_buttons_lessons_delete_notification
from TelegramBot.keyboards.inline.del_subject_or_choice import inline_buttons_delete
from TelegramBot.loader import dp
from TelegramBot.states import Test
from TelegramBot.utils.db_api.PostgreSQL import select_data_olimp_use_id, subscriber_exists, select_data_sub_info, \
